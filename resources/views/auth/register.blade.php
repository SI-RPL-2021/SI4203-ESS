                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="name" class="form-control form-control-user @error('name') is-invalid @enderror" placeholder="Nama Lengkap" name="name" value="{{ old('name') }}">
                                            @error('name')
