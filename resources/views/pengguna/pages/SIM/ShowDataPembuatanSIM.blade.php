        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Pembuatan SIM</h4>
                </div>
                <div class="card-body">
                    <form id="regForm" action="{{ route('post.store') }}" method="post">
                        @csrf
                            ...
                            <table class="table">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>{{ $model->polda_kedatangan}}</td>
                                  </tr>
                                  <tr>
                                    <td>SATPAS Kedatangan</td>
                                    <td>{{ $model->satpas_kedatangan }}</td>
                                  </tr>
                                  <tr>
                                    <td>Biaya</td>
                                    <td>Rp.120.000</td>
