        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Perpanjangan SIM</h4>
                </div>
                <div class="card-body">
                    <form id="regForm" action="{{ route('buat.store') }}" method="post">
                        ...
                        <div class="tab">
                                    ...
                                    <div class="form-check">
                                        <div class="radio">
                                            <label for="radio1" class="form-check-label ">
                                                <input type="radio" id="gol_sim" name="gol_sim" value="a"
                                                    class="form-check-input">A
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label for="radio2" class="form-check-label ">
                                                <input type="radio" id="gol_sim" name="gol_sim" value="b"
                                                    class="form-check-input">B
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label for="radio3" class="form-check-label ">
                                                <input type="radio" id="b" name="gol_sim" value="c"
                                                    class="form-check-input">C
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nomor
                                        SIM</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="no_sim" name="no_sim"
                                        class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Masa Berlaku
                                        SIM</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="masa_berlaku_sim" name="masa_berlaku_sim"
                                        class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Satpas Penerbit/Asal
                                        </label></div>
                                <div class="col-12 col-md-9"><input type="text" id="satpas_penerbit" name="satpas_penerbit"
                                        class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Alamat
                                        Email</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="alamat_email" name="alamat_email"
                                        class="form-control"></div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">SATPAS
                                        Kedatangan</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="satpas_kedatangan" name="satpas_kedatangan"
                                        class="form-control"></div>
                                </div>
                            </div>
                        ...
                        <div class="tab">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col col-md-9">
                                    <div class="form-check">
                                        <div class="radio">
                                            <label for="radio1" class="form-check-label ">
                                                <input type="radio" id="radio1" name="kwn" value="WNI"
                                                    class="form-check-input">WNI
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label for="radio2" class="form-check-label ">
                                                <input type="radio" id="radio2" name="kwn" value="WNA"
                                                    class="form-check-input">WNA
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="nama_lengkap" name="nama_lengkap"
                                        class="form-control"></div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="tinggi" name="tinggi"
                                        class="form-control"></div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Kode
                                        POS</label></div>
                                <div class="col col-sm-4"><input type="text" id="kd_pos" name="kd_pos"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="kota" name="kota"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="alamat" name="alamat"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input"
                                        class=" form-control-label">No.Handphone</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="no_hp" name="no_hp"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="pendidikan" id="pendidikan" class="form-control">
                                        ...
                                        <option value="Diploma D1/2/3">Diploma D1/2/3</option>
                                        <option value="Sarjana S1/2/3">Sarjana S1/2/3</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="select"
                                            class=" form-control-label">Hubungan</label>
                                    </div>
                                    <div class="col-12 col-md-9">
