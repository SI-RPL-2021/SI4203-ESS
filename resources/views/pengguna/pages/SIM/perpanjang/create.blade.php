        ...
        <div class="card">
                    ...
                    <div class="tab">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nomor
                                    SIM</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="no_sim" name="no_sim" class="form-control"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Masa Berlaku
                                    SIM</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="masa_berlaku_sim" name="masa_berlaku_sim" class="form-control"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Satpas Penerbit/Asal
                                </label></div>
                            <div class="col-12 col-md-9"><input type="text" id="satpas_penerbit" name="satpas_penerbit" class="form-control"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Alamat
                                    Email</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="alamat_email" name="alamat_email" class="form-control"></div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">SATPAS
                                    Kedatangan</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="satpas_kedatangan" name="satpas_kedatangan" class="form-control"></div>
                        </div>
                    </div>
            ...
            <div class="tab">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control"></div>
                </div>
